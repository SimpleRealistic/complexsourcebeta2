...
public:
	...
	Vector Getpos1()
	{
		return this->GetBonePos(1);
	}

	Vector Getpos2()
	{
		return this->GetBonePos(2);
	}

	Vector Getpos3()
	{
		return this->GetBonePos(4);
	}

	Vector Getpos4()
	{
		return this->GetBonePos(3);
	}

	Vector Getpos5()
	{
		return this->GetBonePos(5);
	}
	...
	Vector Getpos7()
	{
		return this->GetBonePos(7);
	}

	Vector Getpos9()
	{
		return this->GetBonePos(9);
	}

	Vector Getpos10()
	{
		return this->GetBonePos(10);
	}

	Vector Getpos11()
	{
		return this->GetBonePos(11);
	}

	Vector Getpos12()
	{
		return this->GetBonePos(12);
	}
