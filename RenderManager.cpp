...
void Render::Initialise()
{
	...
	Fonts::Impact = Interfaces::Surface->FontCreate();

	// Font Settings
	Interfaces::Surface->SetFontGlyphSet(Fonts::Watermark, "Arial", 11, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Menu, "Tahoma", 12, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Tahoma", 12, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Tahoma", 12, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "Tahoma", 12, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBY, "Segoe UI", 45, 900, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::complexfont, "complexfont", 115, 900, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Impact, "Impact", 40, 900, 0, 0, FONTFLAG_ANTIALIAS);
}
