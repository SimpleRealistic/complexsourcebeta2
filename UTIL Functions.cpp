...
bool TraceToExit(Vector& end, trace_t& tr, Vector start, Vector vEnd, trace_t* trace)
{
	...
	static TraceToExitFn TraceToExit = (TraceToExitFn)GameUtils::FindPattern1("client.dll", "55 8B EC 83 EC 30 F3 0F 10 75");
...
int GameUtils::GetPlayerCompRank(IClientEntity* pEntity) // 0x75671f7f is crc32 for comp rank netvar, 0x2ED6198 is CCSPlayerResource, 0x1A44 is netvar offset
{
	...
	// DWORD GameResources = GameUtils::FindPattern1(strenc("client.dll"), strenc("8B 3D ? ? ? ? 85 FF 0F 84 ? ? ? ? 81 C7") + 2);
