...
#pragma endregion Contains the VTable Indexs
	...
	/*
	// InitKeyValues
	Functions::KeyValues_KeyValues = GameUtils::FindPattern1(strenc("client.dll"), strenc("55 8B EC 51 33 C0 C7 45"));
	// Functions::KeyValues_KeyValues += 7;
	// Functions::KeyValues_KeyValues = Functions::KeyValues_KeyValues + *reinterpret_cast< PDWORD_PTR >(Functions::KeyValues_KeyValues + 1) + 5;

	// LoadFromBuffer
	Functions::KeyValues_LoadFromBuffer = GameUtils::FindPattern1(strenc("client.dll"), strenc("55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89 4C 24 04"));
	// Functions::KeyValues_LoadFromBuffer = Functions::KeyValues_LoadFromBuffer + *reinterpret_cast< PDWORD_PTR >(Functions::KeyValues_LoadFromBuffer + 1) + 5;
	*/
	...
	Functions::dwIsReady = GameUtils::FindPattern1(strenc("client.dll"), strenc("68 ? ? ? ? 8B 0D ? ? ? ? 8B 01 FF 90 ? ? ? ? 89 B7"));
