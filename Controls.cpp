...
void CCheckBox::Draw(bool hover)
{
	...
	Render::Outline(a.x, a.y, 13, 13, Color(255, 255, 255, 255)); //weiﬂe auﬂenlinie von der checkbox
	int CheckBoxR = 155;
	int CheckBoxG = 255;
	int CheckBoxB = 50;
...
{
	POINT a = GetAbsolutePos();
	Render::Text(a.x, a.y, Color(245, 245, 245, 255), Render::Fonts::MenuBold, Text.c_str()); //TEXt farbe (weiﬂ)
}
...
void CSlider::Draw(bool hover)
{
	...
	Render::Text(a.x + (m_iWidth / 2) - txtSize.right / 2, a.y + 10, Color(255, 255, 255, 255), Render::Fonts::MenuBold, buffer); //Value Farbe (weiﬂ)
}
